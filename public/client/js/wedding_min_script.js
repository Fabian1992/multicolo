! function(a) {
    ...
    function c(b) {
        ...
        a("#" + b + " .form-control").each(function() {
            ...
            var b = a(this).attr("name"),
                d = a(this).val();
            return a(this).css({ border: "1px solid #c4c4c4" }),
                a(this).prop("required") && "" == d ? (a(this).css({ border: "2px solid red" }),
    ...
    "" != b && a("header .wed_logo_animation").addClass("wed_logo_rotate_" + b),
        ...
        a(".wed_particles").length > 0 && a(".wed_particles").particleground({ dotColor: "#fff", lineColor: "#fff", particleRadius: "3", lineWidth: "0.5" }), a(".jqueryFireFly").length > 0 && a(".jqueryFireFly").each(function() {
            var b = a(this).attr("data-total"),
                c = a(this).attr("data-minPixel"),
                d = a(this).attr("data-maxPixel");

            a.firefly({ minPixel: c, maxPixel: d, color: "none", total: b, twinkle: .9, on: ".wed_firefly" })
        ...
        }), a(".wed_over, .wed_head_bck").each(function() {
        ...
        }), a(".wed_map_over").on("click", function(b) { a(this).parents(".wed_section_outter, .wed_inside_map").toggleClass("active_map") }), a(".wed_top_menu_mobile_link").on("click", function(b) { a(this).next(".wed_top_menu_cont").fadeToggle(), a(this).parents(".wed_light_nav").toggleClass("active") }), a(".wed_header_search").on({
            mouseenter: function() {
                a(this).find(".wed_header_search_cont, .wed_header_basket_cont").stop().fadeToggle()
            },
            mouseleave: function() {
                a(this).find(".wed_header_search_cont, .wed_header_basket_cont").stop().fadeToggle()
            }
        }), a(".wed_music_content").on("click", function(b) { b.preventDefault(), a(this).next(".wed_iframe").toggleClass("active") }), a(".wed_go, .wed_top_menu_cont a").on("click", function(b) {
            var c = a(this);

            a("html, body").stop().animate({ scrollTop: a(c.attr("href")).offset().top }, 2300), b.preventDefault()
        }), a("div[data-animation=animation_blocks]").each(function() {
            var b = 0;

            a(this).find(".wed_icon_box, .skill-bar-content, .wed_anim_box, .wed_bd, .wed_story_txt, .wed_portfolio_item_cont").each(function() {
    ...
    a("#nav-sidebar, .wed_top_menu_cont").onePageNav({ currentClass: "current", changeHash: !1, scrollSpeed: 700, scrollOffset: d, scrollThreshold: .5, filter: "", easing: "swing" }), a('[data-toggle="tooltip"]').tooltip(), a('[data-toggle="popover"]').popover(), a(window).scroll(function() {
        a(window).scrollTop() > 100 ? (a(".wed_logo").addClass("active"), a("body").addClass("wed_first_step")) : (a("body").removeClass("wed_first_step"), a(".wed_logo").removeClass("active")), a(window).scrollTop() > 500 ? a("body").addClass("wed_second_step") : a("body").removeClass("wed_second_step"), a(window).scrollTop() > 800 ? a("body").addClass("wed_third_step") : a("body").removeClass("wed_third_step")
    }), a(".wed_fixed").css("background-attachment", "fixed"), a(".wed_parent").on({
        mouseenter: function() {
    ...
    }), a(".wed_mobile_menu_content .wed_parent").on("click", function(b) { a(this).find("ul").slideToggle(300) }), a(".wed_mobile_menu").on("click", function(b) { a(this).toggleClass("active"), a(".wed_mobile_menu_hor").toggleClass("active") }), a(".wed_header_search span").on("click", function(b) { a(this).next(".wed_header_search_cont").fadeToggle() }), device.tablet() || device.mobile() || a(".wed_auto_height").each(function() {
        e(a(this).find('div[class^="col"]'))
    }), device.tablet() && device.landscape() && a(".wed_auto_height").each(function() {
        e(a(this).find('div[class^="col"]'))
        ...
        if (a("body").imagesLoaded(function() {
                a(".wed_page_loader div").fadeOut(), a(".wed_page_loader").delay(200).fadeOut("slow")
